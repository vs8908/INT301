    ...
    <div class="col-sm-6" style="margin-top:40px;">
        <form class="form-horizontal" role="form" method="post" action="ValidateForm.php" novalidate>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="FullName" value="<? echo isset($_POST['FullName']) ? $_POST['FullName'] : 'default_value' ?>" id="FullName" placeholder="Full Name" class="form-control" onclick="RemoveSmall('fn')" autofocus>
                    <? echo $errorMSGName ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="Email" name="Email" value="<? echo isset($_POST['Email']) ? $_POST['Email'] : '' ?>  "id="Email" placeholder="Email" class="form-control" onclick="RemoveSmall('em')">
                    <? echo $errorMSGEmail ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="Username" value=" <? echo isset($_POST['Username']) ? $_POST['Username'] : '' ?> " id="Username" placeholder="Username" class="form-control" onclick="RemoveSmall('un')" autofocus>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="Password" name="Password" value=" <? echo isset($_POST['Password']) ? $_POST['Password'] : '' ?>"   id="Password" placeholder="Password" class="form-control" onclick="RemoveSmall('pw')">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="date" name="birthDate" value=" <? echo isset($_POST['birthDate']) ? $_POST['birthDate'] : '' ?> " onclick="RemoveSmall('bd')" id="birthDate" class="form-control">
                    <? echo $errorMSGDOB ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select id="country" name="country" value="<? echo isset($_POST['country']) ? $_POST['country'] : '' ?> " onclick="RemoveSmall('ct')" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="Mobile" value=" <? echo isset($_POST['Mobile']) ? $_POST['Mobile'] : '' ?>  " id="Mobile" placeholder="Mobile" class="form-control" onclick="RemoveSmall('mb')">
                    <? echo $errorMSGMobile ?>
                </div>
            </div>
            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <label class="radio-inline">
                                <input type="radio" value="<? echo isset($_POST['Gender']) ? $_POST['Gender'] : '' ?>  onclick="RemoveSmall('gd')" "id="Female" name="Gender" value="Female">Female

                            </label>
                        </div>
                        <div class="col-sm-4">
                            <label class="radio-inline">
                                <input type="radio" id="Male" value="<? echo isset($_POST['Gender']) ? $_POST['Gender'] : '' ?> " onclick="RemoveSmall('gd')" name="Gender" value="Male">Male
                            </label>
                        </div>
                    </div>
